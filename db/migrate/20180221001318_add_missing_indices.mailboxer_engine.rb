...
class AddMissingIndices < ActiveRecord::Migration[4.2]
  def change
    ...
    add_index :mailboxer_chat_opt_outs, [:unsubscriber_id, :unsubscriber_type],
      name: 'index_mailboxer_chat_opt_outs_on_unsubscriber_id_type'
    add_index :mailboxer_chat_opt_outs, :chat_id
